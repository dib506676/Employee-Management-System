  ...
  return (
    <div className="flex-shrink-0 h-full p-3 sm:p-4 lg:p-5 w-[280px] sm:w-[300px] bg-green-400 rounded-xl">
      ...
      <div className="mt-3 sm:mt-4">
        <button className="w-full bg-red-500 hover:bg-red-600 py-1 sm:py-2 px-2 sm:px-3 text-xs sm:text-sm rounded-lg transition-colors duration-200">Failed</button>
      </div>
    </div>
  );
}

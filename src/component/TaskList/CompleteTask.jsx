...
function CompleteTask({ data }) {
  return (
    <div className="flex-shrink-0 h-full p-3 sm:p-4 lg:p-5 w-[280px] sm:w-[300px] bg-blue-400 rounded-xl">
      ...
      <div className="mt-3 sm:mt-4">
        <button className="bg-green-500 hover:bg-green-600 w-full py-1 sm:py-2 px-2 sm:px-3 text-xs sm:text-sm rounded-lg transition-colors duration-200">
          Completed Task
        </button>
      </div>
    </div>
